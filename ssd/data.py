...
def get_train_loader(args, local_seed):
    train_annotate = os.path.join(args.data, "annotations/train.json")
    ...
    train_loader = DALICOCOIterator(train_pipe, 8482 / args.N_gpu)
    return train_loader
...
def get_val_dataset(args):
    ...
    val_annotate = os.path.join(args.data, "annotations/test.json")
