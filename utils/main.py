...
def make_parser():
    parser = ArgumentParser(description="Train Single Shot MultiBox Detector"
                                        " on COCO")
    parser.add_argument('--data', '-d', type=str, default='/COCO-Hand', required=True,
    ...
    parser.add_argument('--evaluation', nargs='*', type=int, default=[21, 31, 37, 42, 48, 53, 59, 64 ,80,90,99],
                        help='epochs at which to evaluate')
    # parser.add_argument('--evaluation', nargs='*', type=int, default=[1,3,5,7,9],
    #                     help='epochs at which to evaluate')
...
def train(train_loop_func, logger, args):
    ...
    # transfer learning
    # try:
    #     model_path = 'models/epoch_118.pt'
    #     load_checkpoint(ssd300, model_path)
